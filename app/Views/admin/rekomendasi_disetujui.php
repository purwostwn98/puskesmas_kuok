...
<div class="page-content">
    <div class="page-header">
        <h1 class="page-title text-primary-d2">
            Ajuan Surat Rekomendasi Disetujui
        ...
        <div class="row">
            <div class="col-md-12">
                <table class="table table-striped" id="tablebaru">
                    <thead class="bgc-success text-white">
                        <tr>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="/admin/rekomendasi-detail-ajuan?id=To Approve" class="btn btn-sm btn-primary"><i class="fa fa-edit"></i></a>
                                <a href="/admin/pdf-apotik?id=3" class="btn btn-sm btn-danger"><i class="fa fa-print"></i></a>
                            </td>
                        </tr>
                    </tbody>
                </table>
