...
<div class="page-content">
    <div class="page-header">
        <h1 class="page-title text-primary-d2">
            Ajuan Surat Rekomendasi Ditolak
        ...
        <div class="row">
            <div class="col-md-12">
                <table class="table table-striped" id="tablebaru">
                    <thead class="bgc-secondary text-white">
                        <tr>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>19-01-2024 18:59</td>
                            <td>2243551678909876</td>
                            <td>Paidi</td>
                            <td>Izin Tukang Gigi</td>
                            <td class="text-center"><span class="badge badge-danger">Ditolak</span></td>
                            <td class="text-center">
                                <a href="/admin/rekomendasi-detail-ajuan?id=To Approve" class="btn btn-sm btn-primary"><i class="fa fa-eye"></i></a>
                                <!-- <a href="/admin/rekomendasi-detail-ajuan?id=To Approve" class="btn btn-sm btn-danger"><i class="fa fa-print"></i></a> -->
                            </td>
                        </tr>
                    </tbody>
                </table>
