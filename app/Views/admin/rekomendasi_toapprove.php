...
<div class="page-content">
    <div class="page-header">
        <h1 class="page-title text-primary-d2">
            Ajuan Surat Rekomendasi To Approve
        ...
        <div class="row">
            <div class="col-md-12">
                <table class="table table-striped" id="tablebaru">
                    <thead class="bgc-warning text-white">
                        <tr>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>17-05-2024 17:00</td>
                            <td>3367772777267389</td>
                            <td>Sutarno</td>
                            <td>Izin Usaha Apotik</td>
                            <td class="text-center"><span class="badge badge-warning">To Approve</span></td>
                            <td class="text-center"><a href="/admin/rekomendasi-detail-ajuan?id=To Approve" class="btn btn-sm btn-primary"><i class="fa fa-edit"></i></a></td>
                        </tr>
                    </tbody>
                </table>
            </div>
