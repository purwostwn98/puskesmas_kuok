    ...
    <div class="branding d-flex align-items-center">
      ...
      <div class="container position-relative d-flex align-items-center justify-content-between">
        <a href="index.html" class="logo d-flex align-items-center me-auto">
          ...
          <!-- <img src="<?= base_url(); ?>/assetsdepan/img/logo.png" alt=""> -->
      ...
      <div class="heading">
        <div class="container">
          <div class="row d-flex justify-content-center text-center">
            <div class="col-lg-8">
              <h1>Profil Puskesmas Kuok</h1>
              <p class="mb-0">UPT Puskesmas Kuok merupakan satu-satunya Puskesmas induk di Kecamatan Kuok dan UPT Puskesmas Kuok berada di wilayah Desa Lereng. </p>
