jQuery(function($) {
  ...
  $('#smartwizard-1').smartWizard({
    ...
    toolbarSettings: {
          ...
          toolbarExtraButtons: [
              $('<button class="btn btn-secondary sw-btn-prev"><i class="fa fa-arrow-left mr-1"></i> Previous</button>'),

              $('<button class="btn btn-success sw-btn-next sw-btn-hide">Next <i class="fa fa-arrow-right mr-1"></i></button>'),

              $('<button class="btn btn-purple sw-btn-finish">Finish <i class="fa fa-check mr-1"></i></button>')
              .on('click', function(){
                  //Finish Action
              }),
